...
<div>
  <Link to="/dev_env/shell_script/what_shell_scripts_are_for">
    What Shell Scripts Are For
  </Link>

  <Link to="/dev_env/shell_script/writing_and_running_a_script">
...
<div>
  <Link to="/dev_env/shell_script/variables_arguments_exit_codes">
    Variables, Arguments, and Exit Codes
  </Link>

  <Link to="/dev_env/shell_script/conditionals_and_loops">
    Conditionals and Loops
  </Link>

  <Link to="/dev_env/shell_script/pipes_redirection_command_substitution">
...
<div>
  <Link to="/dev_env/shell_script/safe_scripting_habits">
    Safe Scripting Habits
  </Link>

  <Link to="/dev_env/shell_script/debugging_shell_scripts">
...
<div>
  <Link to="/dev_env/shell_script/scripts_for_system_tasks">

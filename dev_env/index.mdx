...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/docs/system/setup/">
    Set Up Your System →
  </Link>
</div>
...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/docs/system/command_line/">
...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/docs/system/shell_script/">

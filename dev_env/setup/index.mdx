...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/docs/dev_env/setup/macos">
    Set Up macOS →
  </Link>
</div>
...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/docs/dev_env/setup/windows">
    Set Up Windows →
  </Link>
</div>
...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/docs/dev_env/setup/linux">
    Set Up Linux →
  </Link>
</div>

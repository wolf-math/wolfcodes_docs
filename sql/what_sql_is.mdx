...
If you're coming from a regular programming language like [Python](/python/guides/intro/getting_started) or [JavaScript](/javascript/guides/basics/intro), you might think of databases as giant dictionaries or lists. That mental model will trip you up.

**[Python lists](/python/guides/data_structures/lists)** are ordered sequences. You access items by position (`my_list[0]`), iterate in order, and can have duplicates.
...
ORMs (Object-Relational Mappers) like Django ORM or SQLAlchemy are **abstractions** over SQL. They let you write [Python](/python/guides/intro/getting_started) code that generates SQL. Learn more about [Python modules](/python/guides/standard_library/modules) to understand how these tools work:
...
**Imperative** ([Python](/python/guides/intro/getting_started), [JavaScript](/javascript/guides/basics/intro)): "Do this, then do that, then check this condition..."
...
Learn more about [Python for loops](/python/guides/control_flow/for_loops) to understand this pattern.

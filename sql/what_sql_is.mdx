...
**[Python lists](/docs/python/guides/data_structures/lists)** are ordered sequences. You access items by position (`my_list[0]`), iterate in order, and can have duplicates.
...
Learn more about [Python for loops](/docs/python/guides/data_structures/for_loops) to understand this pattern.

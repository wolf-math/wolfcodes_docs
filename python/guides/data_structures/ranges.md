...
Ranges are commonly used with [for loops](/python/guides/control_flow/for_loops) to repeat actions a specific number of times or to iterate through sequences. We'll explore loops in detail in the next section, but here's a brief preview:

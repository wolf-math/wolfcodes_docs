...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/javascript/guides/">
...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/javascript/web/">
...
<div className={styles.buttonContainer}>
  <Link className={`${styles.ctaButton} ${styles.ctaButtonOutline}`} to="/javascript/language_reference/">
    Browse Reference →
  </Link>
</div>
